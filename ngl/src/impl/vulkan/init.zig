...
pub const Device = struct {
    ...
    fn init(_: *anyopaque, allocator: std.mem.Allocator, gpu: ngl.Gpu) Error!Impl.Device {
        ...
        ptr.* = .{
            ...
            .cmdSetRasterizerDiscardEnable = if (has_shader_object)
                @ptrCast(if (Device.getProc(get, dev, "vkCmdSetRasterizerDiscardEnableEXT")) |x|
                    x
                else |_|
            ...
            .cmdSetDepthClampEnable = if (has_shader_object)
                ...
                null,
            .cmdSetDepthBiasEnable = if (has_shader_object)
                @ptrCast(if (Device.getProc(get, dev, "vkCmdSetDepthBiasEnableEXT")) |x|
                    x
                else |_|
            ...
            .cmdSetDepthTestEnable = if (has_shader_object)
                ...
                null,
            .cmdSetDepthCompareOp = if (has_shader_object)
                @ptrCast(if (Device.getProc(get, dev, "vkCmdSetDepthCompareOpEXT")) |x|
                    x
                else |_|
            ...
            .cmdSetDepthWriteEnable = if (has_shader_object)
                ...
                null,
            .cmdSetStencilTestEnable = if (has_shader_object)
                @ptrCast(if (Device.getProc(get, dev, "vkCmdSetStencilTestEnableEXT")) |x|
                    x
                else |_|
    ...
    pub fn vkCmdSetAlphaToOneEnableEXT(
        self: *Device,
        command_buffer: c.VkCommandBuffer,
    ...
    pub fn vkCmdSetDepthBiasEnableEXT(
        self: *Device,
        command_buffer: c.VkCommandBuffer,
    ...
    pub fn vkCmdSetDepthCompareOpEXT(
        self: *Device,
        command_buffer: c.VkCommandBuffer,
    ...
    pub fn vkCmdSetColorBlendEquationEXT(
        ...
        first_attachment: u32,
        attachment_count: u32,
        color_blend_equations: [*]const c.VkColorBlendEquationEXT,
    ) void {
        self.cmdSetColorBlendEquation.?(
            command_buffer,
            first_attachment,
            attachment_count,
        ...
        .core => |*feat| {
            ...
            feat.* = .{
                ...
                .descriptor = .{
                    ...
                    .max_shader_samplers = l.maxPerStageDescriptorSamplers,
                    .max_shader_sampled_images = l.maxPerStageDescriptorSampledImages,
                    .max_shader_storage_images = l.maxPerStageDescriptorStorageImages,
                    .max_shader_uniform_buffers = l.maxPerStageDescriptorUniformBuffers,
                    .max_shader_storage_buffers = l.maxPerStageDescriptorStorageBuffers,
                    .max_shader_resources = l.maxPerStageResources,
                    .max_push_constants_size = l.maxPushConstantsSize,
                    .min_uniform_buffer_offset_alignment = l.minUniformBufferOffsetAlignment,
                    .max_uniform_buffer_size = l.maxUniformBufferRange,
                    .min_storage_buffer_offset_alignment = l.minStorageBufferOffsetAlignment,
                    .max_storage_buffer_size = l.maxStorageBufferRange,
                },
                .vertex_input = .{
...
const vtable = Impl.VTable{
    ...
    .setColorBlendEnable = @import("cmd.zig").CommandBuffer.setColorBlendEnable,
    ...
    .barrier = @import("cmd.zig").CommandBuffer.barrier,
