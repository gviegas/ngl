...
pub const Feature = union(enum) {
    ...
    core: struct {
        ...
        descriptor: struct {
            ...
            max_shader_samplers: u32 = 16,
            max_shader_sampled_images: u32 = 16,
            max_shader_storage_images: u32 = 4,
            max_shader_uniform_buffers: u32 = 12,
            max_shader_storage_buffers: u32 = 4,
            max_shader_resources: u32 = 128,
            max_push_constants_size: u32 = 128,
            min_uniform_buffer_offset_alignment: u64 = 256,
            max_uniform_buffer_size: u64 = 16384,
            min_storage_buffer_offset_alignment: u64 = 256,
            max_storage_buffer_size: u64 = 134217728,
        },
        vertex_input: struct {
            max_bindings: u32 = 8,
