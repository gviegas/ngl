...
// NOTE: The system-specific platforms and relevant member functions
// are marked `pub` so surface tests can access them
// Standalone programs should use the `Platform` wrapper instead
